...
J9::X86::TreeEvaluator::inlineStringLatin1Inflate(TR::Node *node, TR::CodeGenerator *cg)
   ...
   TR::InstOpCode::Mnemonic loadInstructions[] = {MOVQRegMem, MOVDRegMem, MOVZXReg2Mem1, MOVZXReg2Mem1};
   TR::InstOpCode::Mnemonic storeInstructions[] = {MOVDQUMemReg, MOVQMemReg, S2MemReg, S2MemReg};
