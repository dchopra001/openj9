...
public:
	...
	encodeOuterStruct(char *structSig, U_32 sizeInByte)
	{
		...
		printf("\n1st16ByteArray = [");
		for (UDATA i = 0; i < 16; i++) {
			printf("0x%x ", first16ByteComposTypes[i]);
		}
		printf("]\n");
		...
		printf("\nencodeOuterStruct: structSigType = 0x%x\n", structSigType);
	...
	getStructSigTypeFrom16ByteComposTypes(U_8 *first16ByteComposTypes)
	{
		...
		printf("\ngetStructSigTypeFrom16ByteComposTypes: first8ByteComposType = 0x%x", first8ByteComposType);
		printf("\ngetStructSigTypeFrom16ByteComposTypes: second8ByteComposType = 0x%x", second8ByteComposType);
		printf("\nstructSigComposType: structSigComposType = 0x%x\n", structSigComposType);
		...
		printf("\ngetStructSigTypeFrom16ByteComposTypes: structSigType = 0x%x\n", structSigType);
		return structSigType;
	}
